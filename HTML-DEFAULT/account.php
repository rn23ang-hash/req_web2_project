...
<body class="font-lexend bg-gray-50 text-gray-800">
    ...
    <nav class="bg-green-700 shadow-lg sticky top-0 z-10">
        <ul class="max-w-5xl mx-auto flex space-x-8 text-green-50 font-medium p-4">
            <li class="hover:text-white cursor-pointer transition-colors border-b-2 border-white">Cart</li>
            <li class="hover:text-white cursor-pointer transition-colors border-b-2 border-transparent">History</li>
