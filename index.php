                ...
                <div class="flex overflow-x-auto gap-5 pb-4 snap-x mb-8 px-6">
                    ...
                    <div
                        ...
                        <div>
                            ...
                            <h3 class="mt-2 font-semibold text-gray-700">Handwoven Basket</h3>
                            <p class="text-green-600 font-bold">PHP 50</p>
                    ...
                    <div
                        ...
                        <div>
                            ...
                            <h3 class="mt-2 font-semibold text-gray-700 truncate">Paperbag Pack 120pcs</h3>
                            <p class="text-green-600 font-bold">PHP 120</p>
                            <div class="flex items-center text-sm text-gray-600 mt-1">
                                <span class="text-yellow-400 mr-1">★★★★★</span>
                                <span>(5.0)</span>
                            </div>
                    ...
                    <div
                        ...
                        <div>
                            ...
                            <h3 class="mt-2 font-semibold text-gray-700">Wooden Utensil Set</h3>
                            <p class="text-green-600 font-bold">PHP 250</p>
                            <div class="flex items-center text-sm text-gray-600 mt-1">
                                <span class="text-yellow-400 mr-1">★★★★☆</span>
                                <span>(3.8)</span>
                            </div>
