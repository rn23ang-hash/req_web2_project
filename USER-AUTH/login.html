...
<body class="bg-gray-100 font-lexend">
    ...
    <main class="flex flex-col items-center justify-center min-h-screen p-6 text-center bg-green-600">
        ...
        <div class="bg-white p-8 rounded-xl shadow-lg w-full max-w-md flex flex-col text-left">

            <!-- <h1 class="text-center font-bold text-3xl p-2 mb-6">Eco<span class="text-green-500">Shop</span></h1> -->
            ...
            <button id="confirm-login" type="submit" onclick="proceedLogin()" class="bg-green-600 text-white mb-2 font-bold py-2 rounded hover:bg-green-700 transition">
                Login
            </button>
